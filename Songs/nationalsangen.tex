...
% bör du ha en tillgänglig med jag rekommenderar Sublime text som går 
...
% mellanslag.
% Filen skall sparas i .tex format. Om du använder Sublime så kommer
...
% Du får lägga in ditt namn, på samma sätt som ovan. (Om du går
% Open så skall inget klassnamn skrivas med)
% Lycka till!

% Här skall du sätta in en medellång rad från sången. Detta för att veta hur texten ska centreras under kompilering
